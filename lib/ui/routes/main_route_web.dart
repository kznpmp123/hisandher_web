...
class MainRouteWeb extends StatefulWidget {
  static const routeName = '/main_route';
  @override
  _MainRouteWebState createState() => _MainRouteWebState();
}

class _MainRouteWebState extends State<MainRouteWeb> {
  @override
  void initState() {
        ...
        builder: (BuildContext context, AsyncSnapshot<List<Course>> snapshot) {
          if (snapshot.hasData) {
            if (snapshot.data.length == 0){
              ...
              return  CourseListWeb(courses: snapshot.data) ;
            }
          }
